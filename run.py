...
import os
from func import reformat_date, calc_df_avg_Depositors_by_country, avg_depositors_graph, calc_avg_deposits_df, calc_df_avg_Depositors_by_channel, calc_df_advertising_by_date, calc_advertising_by_channel_graphs, calc_roi_per_channel, plot_all_channels_side_by_side
...
calc_advertising_by_channel_graphs(df_advertising, output_dir)
avg_depositors_graph(df_avg_number_Depositors_by_country, 'number_by_country')
avg_depositors_graph(df_avg_depositors_amount_by_country, 'amount_by_country')
avg_depositors_graph(df_avg_number_Depositors_by_channel, 'number_by_channel')
avg_depositors_graph(df_avg_depositors_amount_by_channel, 'amount_by_chanel')
